...
export class DaemonSetTplService {
  ...
  listPage(pageState: PageState, appId?: number): Observable<any> {
    ...
    return this.http
      .get(`/wayne/api/v1/apps/${appId}/daemonsets/tpls`, {params: params})
  ...
  create(tpl: DaemonSetTemplate, appId: number): Observable<any> {
    return this.http
      .post(`/wayne/api/v1/apps/${appId}/daemonsets/tpls`, tpl)
  ...
  update(tpl: DaemonSetTemplate, appId: number): Observable<any> {
    return this.http
      .put(`/wayne/api/v1/apps/${appId}/daemonsets/tpls/${tpl.id}`, tpl, this.options)
  ...
  deleteById(id: number, appId: number, logical?: boolean): Observable<any> {
    ...
    return this.http
      .delete(`/wayne/api/v1/apps/${appId}/daemonsets/tpls/${id}`, options)
  ...
  getById(id: number, appId: number): Observable<any> {
    return this.http
      .get(`/wayne/api/v1/apps/${appId}/daemonsets/tpls/${id}`)
