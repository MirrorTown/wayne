...
export class TektonService {
  ...
  getNames(appId?: number): Observable<any> {
    ...
    return this.http
      .get(`/wayne/api/v1/apps/${appId}/tekton/names`, {params: params})
  ...
  list(pageState: PageState, deleted?: string, appId?: string, operator?: string): Observable<any> {
    ...
    return this.http
      .get(`/wayne/api/v1/apps/${appId}/tekton`, {params: params})
  ...
  create(deployment: Deployment): Observable<any> {
    return this.http
      .post(`/wayne/api/v1/apps/${deployment.appId}/tekton`, deployment)
  ...
  update(tekton: Deployment): Observable<any> {
    return this.http
      .put(`/wayne/api/v1/apps/${tekton.appId}/tekton/${tekton.id}`, tekton, this.options)
  ...
  updateOrder(appId: number, orderList: Array<OrderItem>): Observable<any> {
    return this.http
      .put(`/wayne/api/v1/apps/${appId}/tekton/updateorders`, orderList, this.options)
  ...
  deleteById(id: number, appId: number, logical?: boolean): Observable<any> {
    ...
    return this.http
      .delete(`/wayne/api/v1/apps/${appId}/tekton/${id}`, options)
  ...
  getById(id: number, appId: number): Observable<any> {
    return this.http
      .get(`/wayne/api/v1/apps/${appId}/tekton/${id}`)
